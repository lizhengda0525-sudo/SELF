...
| --- | --- | --- | --- |
| [Super Productivity](https://github.com/super-productivity/super-productivity/tree/23fcdae6195f4742086d7a6099cf69c0079da283)，MIT | src/app/features/tasks/task.model.ts；src/app/op-log/sync/conflict-journal.model.ts | 区分任务日与具体时间；任务关联专注；保留冲突版本 | SELF 首版同步采取整库显式冲突，不移植 Angular/NgRx 操作日志系统 |
